...
var slot_script = preload("res://UI/inventory/scripts/slots/toolSlot.gd")
var bg_style = preload("res://UI/styles/BgStyles/default_bg_inventory.stylebox")
var init = false
...
func slots_gui_input(event: InputEvent, slot: tool_slot):
